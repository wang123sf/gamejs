...
exports.init = function() {
   ...
   FULLSCREEN_CHECKBOX = document.getElementById('gjs-fullscreen-toggle');
   var originalMode = [];
   if (FULLSCREEN_CHECKBOX) {
      FULLSCREEN_CHECKBOX.addEventListener('change', function(event) {
               console.log('setting big mode', window.screen.width);
         originalMode = [getCanvas().width, getCanvas().height];
         setMode([window.screen.width, window.screen.height]);
         toggleFullScreen();
   ...
   var onFullScreenChange = function() {
      FULLSCREEN_CHECKBOX.checked = isFullScreen();
      if (!isFullScreen() && originalMode) {
